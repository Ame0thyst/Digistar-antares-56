...
myApp.controller('namesCtrl', function($scope, $filter,$http) {
    ...
    $scope.editUser = function(user){
        ...
        $scope.crudFormEmail = $scope.users[index].terms;
    ...
    $scope.saveEdit = function(userId){
        if(userId == 'new'){
            ...
            $scope.users[userId].terms = $scope.crudFormTerms  ;
    ...
    $scope.checkTerms = function(userId){
        if(userId === 'new' || $scope.crudFormTerms !== $scope.users[userId].terms){
            $scope.termsExisted = $scope.users.some(function(user){
                return user.terms === $scope.crudFormTerms;
            });                
        }
    }
